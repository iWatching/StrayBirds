...
* 1. ImageUtil图片工具类整理(压缩，截图，角度，合成等)
* 2. 软键盘使用归纳
* 3. 网络库，工具库，framework库版本整理(1.1.0)
* 4. 应用卡顿工具类整理(BlockDetectByPrinter.java)
* 5. 所有发布内容增加点击去重处理(NoDoubleClickListener或者ClickUtil.java方式)
* 6. 贝塞尔曲线实现部分动画效果
* 7. Glide图片库版本更新至4.X系列
* 8. 进一步完善引导库(主页添加引导等)
